...
namespace Blackjack
{
    public partial class Blackjack : Form
    {
        ...
        List<Card> ClientHand = new List<Card>();
        Card[] DealerHand;
        Card[] SplitHand1;
        Card[] SplitHand2;
        ...
        ClientControl ReturnCS;
        NetworkStream clientStream;
        
        BinaryFormatter formatter = new BinaryFormatter();
        int TableNumber;

        public Blackjack(ClientControl ReturnCSVal, NetworkStream NewCS, int Table)
        {
            InitializeComponent();
        ...
        {
            global::Blackjack.Betting NewGame = new global::Blackjack.Betting(PlayerCash);
            ...
            if (NewGame.ShowDialog() == DialogResult.Yes)
            {
                ...
                BetPacket NewPot = new BetPacket();
                NewPot.PlayerBet = NewGame.Bet;
                formatter.Serialize(clientStream, NewPot);
        ...
        void Hit()
        {
            ...
            DrawCardRequest DCR = new DrawCardRequest();
            DCR.TableNum = TableNumber;
            formatter.Serialize(clientStream, DCR);
            //HandIterator++;
        ...
        public void UpdateHand(List<Packets.Card> NewHand)
        {
            ClientHand.Clear();
            ClientHandIterator = 0;

            foreach (Packets.Card C in NewHand)
            {
                Card NewCard = new Card();
                NewCard.Initialize(NewHand[ClientHandIterator].CardSuit, NewHand[ClientHandIterator].value);
                ClientHand.Add(NewCard);
